    ...
    return (
        <div className="flex gap-2 bg-primary_2 rounded p-2 w-full h-14 mb-4">
            <button
                ...
                className={`px-4 py-2 rounded transition-colors w-full h-10 ${activeCategory === 'nowShowing'
            ...
            <button
                ...
                className={`px-4 py-2 rounded transition-colors w-full h-10 ${activeCategory === 'upcoming'
                        ? 'bg-blue-400 text-white cursor-pointer'
                        : 'bg-transparent text-gray-400 cursor-pointer'
                    }`}
            >
